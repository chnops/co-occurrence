...
comm.data.read<-subset(comm.data, reads >= 1407 & trt=="soil")

#in the soils dataset, there was only one dataset that actually had enough reads and samples for rarefication (1407) this would be categorized as "soil"

comm.data.read<-subset(comm.data.read, rep=="soil")
